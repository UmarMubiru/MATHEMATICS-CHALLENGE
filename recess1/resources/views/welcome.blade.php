...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Jul 2024 12:08:54 GMT -->
<head>
  ...
  <!-- Title -->
  <title>Welcome to the National Mathematics Competition!</title>

  <!-- Favicon -->
  <link rel="shortcut icon" href="/assets/img/maths.png">
    ...
    <div class="container-lg">
      <nav class="js-mega-menu navbar-nav-wrap">
        ...
        <a class="navbar-brand" href="index.html" aria-label="Front">
          <img class="navbar-brand-logo" src="assets/img/maths.png" style="height:80px;width:80px;" alt="Logo" data-hs-theme-appearance="default">
          ...
          @if (Route::has('login'))
                            <nav class="-mx-3 flex flex-1 justify-end">
                                @auth
                                    <a
                                        href="{{ url('/dashboard') }}"
                                        class="navbar-btn rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                                    >
                                        Dashboard
                                    </a>
                                @else
                                    <a
                                        href="{{ route('login') }}"
                                        class="py-2 py-lg-3 rounded-md px-3 py-2 text-black ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] dark:text-white dark:hover:text-white/80 dark:focus-visible:ring-white"
                                    >
                                        Log in
                                    </a>
...
<h2 class="fs-2 py-2 py-lg-3">Mathematics Competition Management System</h2>
        </div>
        <!-- End Collapse -->
      </nav>
    </div>
      ...
      <div class="container-lg content-space-t-3 content-space-t-lg-4 content-space-b-2">
        <div class="w-lg-75 text-center mx-lg-auto text-center mx-auto">
          ...
          <div class="mb-7 animated fadeInUp">
            <h1 class="display-2 mb-3">You Are One Step from  <span class="text-primary text-highlight-warning">Becoming the Top Mathematician!</span></h1>
            <p class="fs-2">Most friendly and highly effective Competitions &amp; Rankings.</p>
          </div>
          <!-- End Heading -->
        </div>
    ...
    <div class="content-space-b-2">
      ...
      <div class="container-lg">
        <div class="w-lg-75 text-center mx-lg-auto mb-7 mb-md-10">
          <h2 class="display-4">Equations Unleashed: The Battle of Numbers</h2>
          <p class="lead">In this high-stakes math competition, minds collide, algorithms duel, and mathematical prowess reigns supreme. Participants will grapple with intricate equations, solve mind-bending puzzles, and unravel mathematical mysteries. Whether you’re a seasoned mathlete or a curious novice, prepare to be captivated by the symphony of numbers and the dance of mathematical elegance.</p>
        </div>
      </div>
      <!-- End Heading -->

      <div class="sliding-img mb-5">
        <div class="sliding-img-frame-to-start" style="background-image: url(assets/1.png);height:800px;width:100%;" data-hs-theme-appearance="default"></div>
        <div class="sliding-img-frame-to-start" style="background-image: url(assets/2.png);height:800px;width:100%;" data-hs-theme-appearance="dark"></div>
      </div>

      <div class="sliding-img">
        <div class="sliding-img-frame-to-end" style="background-image: url(assets/3.png);" data-hs-theme-appearance="default"></div>
        <div class="sliding-img-frame-to-end" style="background-image: url(assets/4.png);" data-hs-theme-appearance="dark"></div>
      </div>
    </div>
    <!-- End Sliding Image -->
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-lg-3 mb-5 mb-lg-0">
          <div class="text-center">
            ...
            <p class="fs-3 mb-0">Challenges</p>
          </div>
        </div>
        <!-- End Col -->
        ...
        <div class="col-sm-6 col-lg-3 mb-5 mb-sm-0">
          <div class="text-center">
            ...
            <p class="fs-3 mb-0">Participants</p>
          </div>
        </div>
        <!-- End Col -->
        ...
        <div class="col-sm-6 col-lg-3">
          <div class="text-center">
            <span class="display-3 fw-normal text-dark">47+</span>
            <p class="fs-3 mb-0">Awards</p>
          </div>
        </div>
        <!-- End Col -->
      </div>
  ...
  <footer class="container-lg text-center py-10">
    ...
    <ul class="list-inline mb-3">
      ...
      <li class="list-inline-item">
        <a class="btn btn-soft-secondary btn-sm btn-icon rounded-circle" href="https://github.com/Arokrokie">
          <i class="bi-github"></i>
        </a>
      </li>
    ...
    <p class="mb-0">&copy; 2024 National Mathematics Competition. All rights reserved.</p>
  </footer>
  <!-- ========== END FOOTER ========== -->
...
<!-- Mirrored from htmlstream.com/preview/front-dashboard-v2.1.1/landing.html by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 01 Jul 2024 12:10:03 GMT -->
</html>
