...
<head>
    ...
    <title>{{ __('National Mathematics Competition') }} - {{ $title ?? __('Dashboard') }}</title>
        ...
        <nav class="navbar top-navbar navbar-expand-md">
            <div class="navbar-header" data-logobg="skin6">
                ...
                <div class="navbar-brand">
                    ...
                    <img class="navbar-brand-logo" src="/assets/img/maths.png" style="height:90px;width:90px;" alt="Logo">
                            ...
                            <div class="customize-input">
                                ...
                                <script>
                                    document.getElementById('langChanger').addEventListener('change', function (){
                                        window.location.href = "{{ route('dashboard.setLang') }}?lang=" + this.value;
                                    });
                                </script>
                            </div>
                        </a>
...
<!-- End Left Sidebar -->
    ...
    <div class="page-wrapper">
        ...
        <!-- footer -->
        <footer class="footer text-center text-muted">National Mathematics  <a href="http://127.0.0.1:8000/">Competition</a> 2024.</footer>
        <!-- End footer -->
    </div>
</div>
<!-- End Wrapper -->
